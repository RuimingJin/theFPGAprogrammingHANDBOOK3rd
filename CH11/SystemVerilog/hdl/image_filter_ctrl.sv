// image_filter_ctrl.sv
// ------------------------------------
// AXI4-Lite control/status register file for the image filter
// ------------------------------------
// Author : Frank Bruno
//
// Register map -- deliberately byte-for-byte identical to what Vitis HLS
// generates for this kernel, so the same PYNQ notebook and hil_test.py drive
// either implementation without modification:
//
