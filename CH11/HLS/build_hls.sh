#!/usr/bin/env bash
#
# Build the image_filter HLS component with the unified Vitis flow.
#
...
#
# All four read the same image_filter/hls_config.cfg, which replaces the old
...
CFG=image_filter/hls_config.cfg
WORK=image_filter
...
echo "   $(pwd)/image_filter/hls/impl/ip"
