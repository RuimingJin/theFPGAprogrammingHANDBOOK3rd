...
--               d:/newSPACE/git/The-FPGA-Programming-Handbook-Third-Edition/CH09/SystemVerilog/build/aic3104_dma/aic3104_dma.gen/sources_1/bd/hw/ip/hw_clk_wiz_0_0/hw_clk_wiz_0_0_sim_netlist.vhdl
...
entity hw_clk_wiz_0_0_clk_wiz is
  port (
...
end hw_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of hw_clk_wiz_0_0_clk_wiz is
  signal clk_in1_hw_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_hw_clk_wiz_0_0 : STD_LOGIC;
...
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_hw_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_hw_clk_wiz_0_0,
...
entity hw_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of hw_clk_wiz_0_0 : entity is true;
end hw_clk_wiz_0_0;

architecture STRUCTURE of hw_clk_wiz_0_0 is
begin
inst: entity work.hw_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
