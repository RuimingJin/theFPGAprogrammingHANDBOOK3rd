...
\
  ...
  set flt_temp_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:flt_temp:1.0 flt_temp_0 ]
  ...
  connect_bd_intf_net -intf_net fixed_to_float_M_AXIS_RESULT [get_bd_intf_pins flt_temp_0/fix_temp] [get_bd_intf_pins fixed_to_float/M_AXIS_RESULT]
  connect_bd_intf_net -intf_net flt_temp_0_fh_temp [get_bd_intf_pins flt_temp_0/fh_temp] [get_bd_intf_pins float_to_fixed/S_AXIS_A]
  connect_bd_intf_net -intf_net flt_temp_0_fp_temp [get_bd_intf_pins flt_temp_0/fp_temp] [get_bd_intf_pins float_to_fixed1/S_AXIS_A]
  ...
  [get_bd_pins flt_temp_0/ap_rst_n]
