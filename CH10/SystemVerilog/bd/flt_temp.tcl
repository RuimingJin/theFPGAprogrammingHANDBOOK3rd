...
# module references:
# adt7420_axil_wrapper, flt_temp_wrapper
...
proc create_root_design { parentCell } {
  ...
  set iic_display_io [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 iic_display_io ]


  # Create ports
  set IIC_scl_io [ create_bd_port -dir IO -from 0 -to 0 IIC_scl_io ]
  set IIC_sda_io [ create_bd_port -dir IO -from 0 -to 0 IIC_sda_io ]
...
\
  ...
  set_property CONFIG.C_BUF_TYPE {IOBUF} $util_ds_buf_0
  ...
  # Create instance: adt7420_axil_wrapper_0, and set properties
  set block_name adt7420_axil_wrapper
  set block_cell_name adt7420_axil_wrapper_0
  if { [catch {set adt7420_axil_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adt7420_axil_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: flt_temp_wrapper_0, and set properties
  set block_name flt_temp_wrapper
  set block_cell_name flt_temp_wrapper_0
  if { [catch {set flt_temp_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $flt_temp_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [list \
    ...
    CONFIG.C_Rate {1} \
    CONFIG.C_Result_Exponent_Width {8} \
    CONFIG.C_Result_Fraction_Width {7} \
    CONFIG.Flow_Control {NonBlocking} \
    CONFIG.Has_ARESETn {true} \
    CONFIG.Has_RESULT_TREADY {false} \
  ...
  # Create instance: float_to_fixed1, and set properties
  set float_to_fixed1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:floating_point:7.1 float_to_fixed1 ]
  set_property -dict [list \
    CONFIG.C_Latency {6} \
    CONFIG.C_Mult_Usage {No_Usage} \
    CONFIG.C_Rate {1} \
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports iic_display_io] [get_bd_intf_pins axi_iic_0/IIC]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins adt7420_axil_wrapper_0/s_axi] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins axi_iic_0/S_AXI]
  connect_bd_intf_net -intf_net fixed_to_float_M_AXIS_RESULT [get_bd_intf_pins fixed_to_float/M_AXIS_RESULT] [get_bd_intf_pins flt_temp_wrapper_0/fix_temp]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_addsub_a [get_bd_intf_pins flt_temp_wrapper_0/addsub_a] [get_bd_intf_pins fp_addsub/S_AXIS_A]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_addsub_b [get_bd_intf_pins flt_temp_wrapper_0/addsub_b] [get_bd_intf_pins fp_addsub/S_AXIS_B]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_addsub_op [get_bd_intf_pins flt_temp_wrapper_0/addsub_op] [get_bd_intf_pins fp_addsub/S_AXIS_OPERATION]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_fh_temp [get_bd_intf_pins flt_temp_wrapper_0/fh_temp] [get_bd_intf_pins float_to_fixed/S_AXIS_A]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_fp_temp [get_bd_intf_pins flt_temp_wrapper_0/fp_temp] [get_bd_intf_pins float_to_fixed1/S_AXIS_A]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_fused_a [get_bd_intf_pins fp_fused_mult_add/S_AXIS_A] [get_bd_intf_pins flt_temp_wrapper_0/fused_a]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_fused_b [get_bd_intf_pins fp_fused_mult_add/S_AXIS_B] [get_bd_intf_pins flt_temp_wrapper_0/fused_b]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_fused_c [get_bd_intf_pins fp_fused_mult_add/S_AXIS_C] [get_bd_intf_pins flt_temp_wrapper_0/fused_c]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_mult_a [get_bd_intf_pins flt_temp_wrapper_0/mult_a] [get_bd_intf_pins fp_mult/S_AXIS_A]
  connect_bd_intf_net -intf_net flt_temp_wrapper_0_mult_b [get_bd_intf_pins flt_temp_wrapper_0/mult_b] [get_bd_intf_pins fp_mult/S_AXIS_B]
  connect_bd_intf_net -intf_net fp_addsub_M_AXIS_RESULT [get_bd_intf_pins fp_addsub/M_AXIS_RESULT] [get_bd_intf_pins flt_temp_wrapper_0/addsub]
  connect_bd_intf_net -intf_net fp_fused_mult_add_M_AXIS_RESULT [get_bd_intf_pins fp_fused_mult_add/M_AXIS_RESULT] [get_bd_intf_pins flt_temp_wrapper_0/fused]
  connect_bd_intf_net -intf_net fp_mult_M_AXIS_RESULT [get_bd_intf_pins fp_mult/M_AXIS_RESULT] [get_bd_intf_pins flt_temp_wrapper_0/mult]
  ...
  connect_bd_net -net Net  [get_bd_ports IIC_scl_io] \
  [get_bd_pins util_ds_buf_0/IOBUF_IO_IO]
  connect_bd_net -net Net1  [get_bd_ports IIC_sda_io] \
  [get_bd_pins util_ds_buf_1/IOBUF_IO_IO]
  connect_bd_net -net adt7420_axil_wrapper_0_temp_inst  [get_bd_pins adt7420_axil_wrapper_0/temp_inst] \
  [get_bd_pins fixed_to_float/s_axis_a_tdata]
  connect_bd_net -net adt7420_axil_wrapper_0_temp_inst_valid  [get_bd_pins adt7420_axil_wrapper_0/temp_inst_valid] \
  [get_bd_pins fixed_to_float/s_axis_a_tvalid]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SCL_o  [get_bd_pins adt7420_axil_wrapper_0/scl_o] \
  [get_bd_pins util_ds_buf_0/IOBUF_IO_I]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SCL_t  [get_bd_pins adt7420_axil_wrapper_0/scl_t] \
  [get_bd_pins util_ds_buf_0/IOBUF_IO_T]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SDA_o  [get_bd_pins adt7420_axil_wrapper_0/sda_o] \
  [get_bd_pins util_ds_buf_1/IOBUF_IO_I]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SDA_t  [get_bd_pins adt7420_axil_wrapper_0/sda_t] \
  [get_bd_pins util_ds_buf_1/IOBUF_IO_T]
  connect_bd_net -net float_to_fixed1_m_axis_result_tdata  [get_bd_pins float_to_fixed1/m_axis_result_tdata] \
  [get_bd_pins adt7420_axil_wrapper_0/fx_inst]
  connect_bd_net -net float_to_fixed1_m_axis_result_tvalid  [get_bd_pins float_to_fixed1/m_axis_result_tvalid] \
  [get_bd_pins adt7420_axil_wrapper_0/fx_inst_valid]
  connect_bd_net -net float_to_fixed_m_axis_result_tdata  [get_bd_pins float_to_fixed/m_axis_result_tdata] \
  [get_bd_pins adt7420_axil_wrapper_0/fh_inst]
  connect_bd_net -net float_to_fixed_m_axis_result_tvalid  [get_bd_pins float_to_fixed/m_axis_result_tvalid] \
  [get_bd_pins adt7420_axil_wrapper_0/fh_inst_valid]
  connect_bd_net -net rst_ps8_0_95M_peripheral_aresetn  [get_bd_pins rst_ps8_0_95M/peripheral_aresetn] \
  [get_bd_pins axi_smc/aresetn] \
  [get_bd_pins fp_mult/aresetn] \
  [get_bd_pins fp_addsub/aresetn] \
  [get_bd_pins fp_fused_mult_add/aresetn] \
  [get_bd_pins float_to_fixed/aresetn] \
  [get_bd_pins float_to_fixed1/aresetn] \
  [get_bd_pins fixed_to_float/aresetn] \
  [get_bd_pins adt7420_axil_wrapper_0/s_axi_aresetn] \
  [get_bd_pins flt_temp_wrapper_0/rst_n] \
  [get_bd_pins axi_iic_0/s_axi_aresetn]
  connect_bd_net -net util_ds_buf_0_IOBUF_IO_O  [get_bd_pins util_ds_buf_0/IOBUF_IO_O] \
  [get_bd_pins adt7420_axil_wrapper_0/scl_i]
  connect_bd_net -net util_ds_buf_1_IOBUF_IO_O  [get_bd_pins util_ds_buf_1/IOBUF_IO_O] \
  [get_bd_pins adt7420_axil_wrapper_0/sda_i]
  ...
  [get_bd_pins fp_mult/aclk] \
  [get_bd_pins fp_addsub/aclk] \
  [get_bd_pins fp_fused_mult_add/aclk] \
  [get_bd_pins float_to_fixed/aclk] \
  [get_bd_pins float_to_fixed1/aclk] \
  [get_bd_pins fixed_to_float/aclk] \
  [get_bd_pins adt7420_axil_wrapper_0/s_axi_aclk] \
  [get_bd_pins flt_temp_wrapper_0/clk] \
  ...
  assign_bd_address -offset 0x80000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs adt7420_axil_wrapper_0/s_axi/reg0] -force
