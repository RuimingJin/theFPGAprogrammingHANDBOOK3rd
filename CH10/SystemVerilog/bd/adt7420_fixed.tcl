...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set TMP_SCL [ create_bd_port -dir IO -from 0 -to 0 TMP_SCL ]
  set TMP_SDA [ create_bd_port -dir IO -from 0 -to 0 TMP_SDA ]
...
\
  ...
  # Create instance: adt7420_i2c_mod_wrap_0, and set properties
  set block_name adt7420_i2c_mod_wrapper
  set block_cell_name adt7420_i2c_mod_wrap_0
  if { [catch {set adt7420_i2c_mod_wrap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adt7420_i2c_mod_wrap_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins adt7420_i2c_mod_wrap_0/s_axi]
  ...
  connect_bd_net -net Net  [get_bd_ports TMP_SCL] \
  [get_bd_pins util_ds_buf_0/IOBUF_IO_IO]
  connect_bd_net -net Net1  [get_bd_ports TMP_SDA] \
  [get_bd_pins util_ds_buf_1/IOBUF_IO_IO]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SCL_o  [get_bd_pins adt7420_i2c_mod_wrap_0/TMP_SCL_o] \
  [get_bd_pins util_ds_buf_0/IOBUF_IO_I]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SCL_t  [get_bd_pins adt7420_i2c_mod_wrap_0/TMP_SCL_t] \
  [get_bd_pins util_ds_buf_0/IOBUF_IO_T]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SDA_o  [get_bd_pins adt7420_i2c_mod_wrap_0/TMP_SDA_o] \
  [get_bd_pins util_ds_buf_1/IOBUF_IO_I]
  connect_bd_net -net adt7420_i2c_mod_wrap_0_TMP_SDA_t  [get_bd_pins adt7420_i2c_mod_wrap_0/TMP_SDA_t] \
  ...
  [get_bd_pins adt7420_i2c_mod_wrap_0/s_axi_aclk]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs adt7420_i2c_mod_wrap_0/s_axi/reg0] -force
